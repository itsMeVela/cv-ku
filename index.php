...
<body>
                        ...
                        <div class="row">
                            <div class="col-4 ">
                                <div class="card mt-5 shadow border border-0 bg-body-tertiary rounded">
                                    <div class="card-body">
                                        <h1 class="card-title"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 496 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                            ...
                            <div class="col-4 ">
                                <div class="card mt-5 shadow border border-0 bg-body-tertiary rounded">
                                    <div class="card-body">
                                        <h1 class="card-title"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                            ...
                            <div class="col-4 ">
                                <div class="card mt-5 shadow border border-0 bg-body-tertiary rounded">
                                    <div class="card-body">
                                        <h1 class="card-title"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
    ...
    <div class="container" style="margin-top:18%;">
        <div class="row" style="padding-top: 10%; padding-bottom: 10%;">
            <div class="row">
                <div class="col-5">
                    <h2 class="text-warning" style="font-size: 60px;"> Connect With Me</h2>
                    <div class="input-group mb-3">
                        <input type="text " class="form-control" placeholder="Email" aria-label="Email">
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Messge" aria-label="Messge">
                    </div>
                    <div>
                        <button type="button" class="btn btn-outline-warning mt-4 btn-lg text-dark">Stay Connected <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                <style>
                                    svg {
                                        fill: #1f2951
                                    }
