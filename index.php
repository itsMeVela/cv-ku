...
<body>
    ...
    <div class="container">
        <div class="row" style="margin-top: 20%;">
            <div class="col-10">
                <h1 style="font-size: 80px;">Hello, I'm <br> a Front end Developer</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 ">
                                <div class="card mt-5 shadow border border-0 bg-body-tertiary rounded">
                                    <div class="card-body">
                                        <h1 class="card-title">
                                            <svg style="fill: #eea111" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                            ...
                            <div class="col-4 ">
                                <div class="card mt-5 shadow border border-0 bg-body-tertiary rounded">
                                    <div class="card-body">
                                        <h1 class="card-title">
                                            <svg style="fill: #eea111" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
